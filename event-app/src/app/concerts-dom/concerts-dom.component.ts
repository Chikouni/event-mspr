...
@Component({
  selector: 'app-concerts-dom',
  templateUrl: './concerts-dom.component.html',
  styleUrls: ['./concerts-dom.component.scss']
})
export class ConcertsDomComponent implements OnInit {
  ...
  goSamedi(){
    this.router.navigate(['concerts/samedi']);
  }
